...
public class BuscarProductoGUI extends javax.swing.JInternalFrame {
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        try {
            ...
            rsProd = productoDAO.search(nombre);
            while (rsProd.next()) {
                Object[] registro = {
                    rsProd.getInt(1),
                    rsProd.getString(2),
    ...
    private void tblRegistrosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistrosMouseClicked
        try {
            FacturaGUI.txtIdProducto.setText(tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 0).toString());
            FacturaGUI.txtNombProd.setText(tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 1).toString());
            FacturaGUI.txtPrecio.setText(tblRegistros.getValueAt(tblRegistros.getSelectedRow(), 2).toString());
            this.dispose();
        } catch (Exception e) {
